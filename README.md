...
In this paper, we design non-adaptive and adaptive one-bit communication protocols for for distributions drawn from scale–location families with unknown variance. We derive  asymptotic bounds on the achievable Mean Squared Error (MSE).
